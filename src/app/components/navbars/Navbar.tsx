...
export default function Navbar({ setShowSidebar, lightMode }: Props) {
  return (
    <nav className={`${style.nav} ${lightMode ? style.lightMode : undefined}`}>
      <ul>
        <li>
          <a href="#">
            日本<i>GO</i>
        ...
        <li onClick={() => setShowSidebar(true)}>
          <a href="#">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={lightMode ? 'black' : 'white'}>
